...
(e.g. function returns and channels) and not depend on bus subscriptions for critical interactions. The bus is provided
only as a means for consumers to observe events emitted from the library (such as to provide a rich UI).
*/
package bus
